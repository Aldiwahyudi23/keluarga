                    ...
                    <td>
                        <form action="{{ route('kelas.destroy', $data->id) }}" method="post">
                            ...
                            <button type="button" class="btn btn-info btn-sm" onclick="getSubsSiswa({{$data->id}})" data-toggle="modal" data-target=".view-siswa">
                              <i class="nav-icon fas fa-users"></i> &nbsp; Lihat
                            </button>
                            <a href="{{ url('kas/data_pengluaran') }}" class="btn btn-success btn-sm">Data Pengluaran</a>
  ...
  <script>
    function getCreateKelas(){
      ...
      $('#form_nama').html(`
        ...
        <input type='text' id="nama_kelas" onkeyup="this.value = this.value.toUpperCase()" name='nama_kelas' class="form-control @error('nama_kelas') is-invalid @enderror" placeholder="{{ __('Nama Program') }}">
      `);
      $('#nama_kelas').val('');
      $('#form_paket').html('');
      $('#form_paket').html(`
