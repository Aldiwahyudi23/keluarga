...
@section('heading', 'Details Pengurus')
@section('page')
  <li class="breadcrumb-item active"><a href="{{ route('guru.index') }}">Pengurus</a></li>
  <li class="breadcrumb-item active">Details Pengurus</li>
@endsection
@section('content')
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body table-responsive">
            <div class="row no-gutters ml-2 mb-2 mr-2">
                ...
                <div class="col-md-7">
                    ...
                    <h5 class="card-title card-text mb-2">Jabatan : {{ $guru->mapel->nama_mapel }}</h5>
