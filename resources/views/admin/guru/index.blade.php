    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                ...
                <a href="{{ route('guru.export_excel') }}" class="btn btn-success btn-sm my-3" target="_blank"><i class="nav-icon fas fa-file-export"></i> &nbsp; EXPORT</a>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
                            ...
                            <div class="card card-outline card-primary">
                                ...
                                <div class="card-body">
                                    <ul>
                                        <li>rows 1 = nama pengurus/li>
                                        <li>rows 2 = nip prngurus</li>
                                        <li>rows 3 = jenis kelamin</li>
                                        <li>rows 4 = Jabatan</li>
                                    </ul>
                                </div>
                            </div>
      ...
      <div class="modal-body">
          <form action="{{ route('guru.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="nama_guru">Nama Pengurus</label>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="mapel_id">Jabtan</label>
